...
export default {
  data() {
    return {
      ...
      src:"https://ddapp.blueseashark.cn"
    };
  },
    ...
    async Submission() {
      if (
        ...
        let { data } = await this.$axios.get(
          "https://ddapp.blueseashark.cn/update/android",
          {
            params: {
